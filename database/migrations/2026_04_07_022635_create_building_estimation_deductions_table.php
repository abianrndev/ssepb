...
return new class extends Migration
{
    ...
    {
        Schema::create('building_estimation_deductions', function (Blueprint $table) {
            $table->id();
            $table->foreignId('building_estimation_id')->constrained()->cascadeOnDelete();

            $table->string('jenis_pengurang'); // void, shaft, bukaan, dll
    ...
    {
        Schema::dropIfExists('building_estimation_deductions');
    }
};