    ...
    <div class="header">
        <table class="header-table">
            <tr>
                ...
                {{-- Info dokumen — rata kanan, lebar pas --}}
        ...
        <div class="box">
            <table class="info-table">
                @forelse(($parameters ?? []) as $row)
                    <tr>
                        <td class="label" style="width: 90px;">{{ $row['label'] ?? '-' }}</td>
                        <td>: {{ $row['value'] ?? '-' }}</td>
                    </tr>
                @empty
                    <tr>
                ...
                <tr>
                    ...
                    <td style="width: 55%; padding: 6px 8px; vertical-align: top;">
                        <table class="summary-table">
                            <tr>
                                <td style="width: 140px; color: #4b5563;">Volume Kotor</td>
                                <td>: {{ $summary['volume_kotor'] ?? '-' }} m³</td>
                            </tr>
                            <tr>
                                <td style="color: #4b5563;">Volume Pengurang</td>
                                <td>: {{ $summary['volume_pengurang'] ?? '-' }} m³</td>
                            </tr>
                            <tr>
                                <td style="color: #4b5563;">Volume Bersih</td>
                                <td>: {{ $summary['volume_bersih'] ?? '-' }} m³</td>
                            </tr>
                            <tr>
                                <td style="color: #4b5563;">Waste Volume</td>
                                <td>: {{ $summary['waste_volume'] ?? '-' }} m³</td>
                            </tr>
                            <tr>
                                <td style="color: #4b5563;">Total Akhir</td>
                                <td>: {{ $summary['total_akhir_m3'] ?? '-' }} m³</td>
                            </tr>
                            <tr>
                                <td style="color: #4b5563;">Harga Beton per m³</td>
                                <td>: Rp {{ $summary['harga_per_m3'] ?? '-' }}</td>
                            </tr>
                        </table>
                    </td>
                    {{-- Kanan: total highlight --}}
